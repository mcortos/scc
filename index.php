        ...
        <div class="card mb-4 box-shadow">
          ...
          <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
              <li><span class="col-xs-4 text-left">0-150K</span><span class="col-xs-4  text-right"><?php echo '$2000'. $t1.' ';?></span></li>
              <li><span class="col-xs-4 text-left">150-500K</span><span class="col-xs-4  text-right"><?php echo '$234555'. $t2.' ';?></span></li>
